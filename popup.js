...
const I18N = {
  ru: {
    ...
    aboutDescr:    'Selection TranslateAI — переводит выделенный текст через ИИ и объясняет грамматику слова в контексте предложения. Работает через ваши собственные API-ключи OpenAI, Claude, Grok или Gemini.',
  ...
  en: {
    ...
    noKey:         'no key set',
    aboutTitle:    'About',
    aboutDescr:    'Selection TranslateAI translates selected text with AI and explains word grammar in the sentence context. Powered by your own OpenAI, Claude, Grok or Gemini API keys.',
  ...
  es: {
    ...
    aboutDescr:    'Selection TranslateAI traduce el texto seleccionado con IA y explica la gramática de la palabra en el contexto de la frase. Funciona con tus propias claves API de OpenAI, Claude, Grok o Gemini.',
  ...
  zh: {
    ...
    noKey:         '未设置密钥',
    aboutTitle:    '关于',
    aboutDescr:    'Selection TranslateAI 使用 AI 翻译选中的文本，并在句子语境中解释单词的语法。使用您自己的 OpenAI、Claude、Grok 或 Gemini API 密钥。',
    aboutContact:  '联系：',
    aboutWebsite:  '网站：',
